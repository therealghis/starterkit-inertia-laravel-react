...
namespace Shellrent\KrakenClient\Laravel\Facades {
    ...
    class KrakenLogger {
        ...
        {
            /** @var \Shellrent\KrakenClient\Laravel\KrakenLogger $instance */
            return $instance->log($level, $message);
        }
        ...
        {
            //Method inherited from \Shellrent\KrakenClient\GenericKrakenLogger 
            /** @var \Shellrent\KrakenClient\Laravel\KrakenLogger $instance */
            return $instance->emergency($message);
        }
        ...
        public static function critical($message)
        {
            //Method inherited from \Shellrent\KrakenClient\GenericKrakenLogger 
            /** @var \Shellrent\KrakenClient\Laravel\KrakenLogger $instance */
            return $instance->critical($message);
        }
        ...
        public static function notice($message)
        {
            //Method inherited from \Shellrent\KrakenClient\GenericKrakenLogger 
            /** @var \Shellrent\KrakenClient\Laravel\KrakenLogger $instance */
            return $instance->notice($message);
        }
...
namespace  {
    ...
    class KrakenLogger extends \Shellrent\KrakenClient\Laravel\Facades\KrakenLogger {}
}
